...
import { X, Upload, FolderOpen, Image, FileText, Edit, Trash2, File } from 'lucide-react';
...
const DrawingsGrid: React.FC<DrawingsGridProps> = ({ projectId }) => {
  ...
  const handleDeleteDrawing = (id: string, storagePath: string) => {
    if (window.confirm('Are you sure you want to delete this file? This action cannot be undone.')) {
      deleteDrawingMutation.mutate({ id, storagePath });
    }
  };
                      ...
                      <div className="relative aspect-video bg-muted">
                        ...
                        <div className="absolute top-2 right-2 flex items-center space-x-1">
                          <Button 
                            ...
                            onClick={(e) => {
                              e.stopPropagation();
                              handleDeleteDrawing(drawing.id, drawing.storage_path);
                            }}
