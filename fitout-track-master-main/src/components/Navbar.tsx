...
const Navbar = () => {
  ...
  const { user, logout, isAdmin, isCoordinator, isContractor } = useAuth();
      ...
      <nav className="bg-white border-b border-gray-200 shadow-sm">
            ...
            <div className="flex items-center">
              ...
              {!isMobile && user && (
                <div className="ml-10 flex items-center space-x-4">
                  ...
                  {/* Project Selector for Contractors */}
                  {isContractor && <ProjectSelector />}
                </div>
              )}
            </div>
        ...
        {isMobile && isMenuOpen && user && (
          <div className="bg-white border-b border-gray-200 px-4 py-3 sm:hidden animate-fade-in">
            ...
            {/* Mobile Project Selector for Contractors */}
            {isContractor && (
              <div className="mb-3">
                <ProjectSelector />
              </div>
            ...
            <div className="flex flex-col">
              ...
              <div className="border-t border-gray-200 mt-3 pt-3">
                <button
                  ...
                  className="px-3 py-2 rounded-md text-base font-medium text-gray-500 hover:text-gray-900 hover:bg-gray-100 flex items-center w-full text-left"
                >
