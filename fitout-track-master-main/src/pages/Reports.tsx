...
const Reports = () => {
  ...
  const handleExportPDF = async () => {
    try {
      // Fetch photos for the selected project if there's one selected
      let projectPhotos: Drawing[] = [];
      
      if (selectedProjectId) {
        try {
          projectPhotos = await getDrawingsByProjectId(selectedProjectId);
      ...
      // Update export config to include photos
      const updatedConfig = {
        ...exportConfig,
        includePhotos: true,
